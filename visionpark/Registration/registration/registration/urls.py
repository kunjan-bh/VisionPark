...
urlpatterns = [
    ...
    path('esewa-payment/', views.esewa, name = 'esewapay'),
    path('payment-method/', views.paymment_method, name = 'paymentmethod'),
    path('payment-methodflex/', views.paymment_methodflex, name = 'paymentmethodflex'),
    path('esewa-payment/chatbot/', views.chat_bot, name = 'chatbot-esewa-payment'),
    path('esewa-paymentflex/', views.esewa_flex, name = 'esewapayflex'),
    path('payment-fail/', views.fail_payment, name = 'paymentfail'),
    path('extend_epay/', views.extend_epay, name = 'extendesewa_pay'),
    path('confirm_epay_extend/', views.confirm_extend, name = 'confirmextend_epay'),
]
